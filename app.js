...
const locales = {
  "zh-TW": {
    ...
    "hero.btnDownload": "免費下載跨平台免安裝包 (.zip)",
    ...
    "download.desc": "本機運行，免除繁瑣設定。下載跨平台免安裝包即可解壓體驗。",
    "download.zip_span": "免費下載",
    "download.zip_label": "跨平台免安裝包 (ZIP)",
  ...
  "en": {
    ...
    "hero.btnDownload": "Download Portable Package (.zip)",
    ...
    "download.desc": "Local execution, zero setup friction. Download the portable zip package to start.",
    "download.zip_span": "Free Download",
    "download.zip_label": "Portable Package (ZIP)",
  ...
  "ja": {
    ...
    "hero.btnDownload": "ポータブルパッケージをダウンロード (.zip)",
    ...
    "download.desc": "ローカル実行、設定不要。ポータブル ZIP パッケージをダウンロードして開始してください。",
    "download.zip_span": "ダウンロード",
    "download.zip_label": "ポータブル ZIP パッケージ",
  ...
  "zh-CN": {
    ...
    "hero.btnDownload": "免费下载跨平台免安装包 (.zip)",
    ...
    "download.desc": "本地运行，免除繁琐设置。下载跨平台免安装包即可解压体验。",
    "download.zip_span": "免费下载",
    "download.zip_label": "跨平台免安装包 (ZIP)",
    "download.github_span": "前往",
